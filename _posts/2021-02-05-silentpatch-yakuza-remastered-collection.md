...
job and something else, and the job does not its input data prepared correctly, and thus crashes. Thankfully, said job already has some failure handling in place,
...
* Reportedly, Yakuza 3 freezes often on exiting the hostess clubs.
